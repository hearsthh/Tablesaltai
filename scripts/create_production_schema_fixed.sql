-- Restaurant Management Platform - Production Database Schema (Fixed)
...
DROP TYPE IF EXISTS restaurant_type CASCADE;
DROP TYPE IF EXISTS price_range CASCADE;

-- Create custom types (fresh creation)
...
DROP POLICY IF EXISTS "Users can view own restaurant profile" ON restaurant_profiles;
DROP POLICY IF EXISTS "Users can insert own restaurant profile" ON restaurant_profiles;
DROP POLICY IF EXISTS "Users can update own restaurant profile" ON restaurant_profiles;
...
DROP POLICY IF EXISTS "Users can manage own review settings" ON review_settings;
DROP POLICY IF EXISTS "Users can view own analytics" ON restaurant_analytics;
DROP POLICY IF EXISTS "Users can manage own integrations" ON platform_integrations;
...
DROP TRIGGER IF EXISTS update_analytics_on_review_change ON reviews;

DROP FUNCTION IF EXISTS update_updated_at_column();
DROP FUNCTION IF EXISTS update_restaurant_analytics();
